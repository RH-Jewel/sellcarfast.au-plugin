...
/*
Plugin Name: Drivco Core
Plugin URI: https://themeforest.net/user/egenslab/portfolio
Description: Drivco Core plugin is a Elementor Widget Based Plugin.
Author: Egens Lab
Author URI: https://themeforest.net/user/egenslab/
Version: 1.3.0
Text Domain: drivco-core
*/
...
final class Egns_Core
{
    ...
    public function egns_core_require_files()
    {
        ...
        $includes_files = array(
            ...
            array(
                'file-name' => 'ajax_handler',
                'folder-name' => EGNS_CORE_ROOT_PATH . '/helpers'
            ),

            // location ajax handler
            array(
                'file-name' => 'ajax_handler_location',
                'folder-name' => EGNS_CORE_ROOT_PATH . '/helpers'
            ),
            ...
            array(
                'file-name' => 'cpt',
                'folder-name' => EGNS_CORE_INC . '/custome-post',
            ),
