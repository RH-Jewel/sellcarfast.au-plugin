...
function egens_core_import_files()
{
	...
	return array(
		array(
			'import_file_name'           => esc_html('Drivco'),
			...
			'import_notice'              => __('Import process may take 3-5 minutes, please be patient. It\'s really based on your network speed.', 'drivco-core'),
			'preview_url'                => '#',
		),
	);
}
...
function egens_core_after_import_setup()
{
	...
	$mega_menu = get_term_by('name', 'Header Two Second Menu', 'nav_menu');
	...
	// Update Woocommerce Time Formate
	update_option('simple_auctions_countdown_format', 'dHMS');
