...
class Egns_Social_Link_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            // Widget name
            __('Egns Social Link', 'drivco-core'),

            // Widget description
            array('description' => __('Egens Social Link', 'drivco-core'),)
        );
    }
...
?>
        <ul class="social-link">
            ...
            <?php if (!empty($instance['facebook_url'])) : ?>
                <li>
                    <a href="<?php echo  esc_url(__($instance['facebook_url'], 'drivco-core')); ?>"><i class="bx bxl-facebook"></i>
                        <span><?php echo  esc_html(__($instance['facebook_txt'], 'drivco-core')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if (!empty($instance['instagram_url'])) : ?>
                <li><a href="<?php echo  esc_url(__($instance['instagram_url'], 'drivco-core')); ?>"><i class="bx bxl-instagram"></i>
                        <span><?php echo  esc_html(__($instance['instagram_txt'], 'drivco-core')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if (!empty($instance['linkedin_url'])) : ?>
                <li><a href="<?php echo  esc_url(__($instance['linkedin_url'], 'drivco-core')); ?>"><i class='bx bxl-linkedin'></i>
                        <span><?php echo  esc_html(__($instance['linkedin_txt'], 'drivco-core')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if (!empty($instance['twitter_url'])) : ?>
                <li>
                    <a href="<?php echo  esc_url(__($instance['twitter_url'], 'drivco-core')); ?>"><i class="bx bxl-twitter"></i>
                        <span><?php echo  esc_html(__($instance['twitter_txt'], 'drivco-core')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if (!empty($instance['dribbble_url'])) : ?>
                <li>
                    <a href="<?php echo  esc_url(__($instance['dribbble_url'], 'drivco-core')); ?>"><i class="bx bxl-dribbble"></i>
                        <span><?php echo  esc_html(__($instance['dribbble_txt'], 'drivco-core')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if (!empty($instance['pinterest_url'])) : ?>
                <li><a href="<?php echo  esc_url(__($instance['pinterest_url'], 'drivco-core')); ?>"><i class="bx bxl-pinterest"></i>
                        <span><?php echo  esc_html(__($instance['pinterest_txt'], 'drivco-core')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            <?php if (!empty($instance['whatsapp_url'])) : ?>
                <li><a href="<?php echo  esc_url(__($instance['whatsapp_url'], 'drivco-core')); ?>"><i class='bx bxl-whatsapp'></i>
                        <span><?php echo  esc_html(__($instance['whatsapp_txt'], 'drivco-core')); ?></span>
                        ` </a>
                </li>`
            <?php endif; ?>
            <?php if (!empty($instance['youtube_url'])) : ?>
                <li><a href="<?php echo  esc_url(__($instance['youtube_url'], 'drivco-core')); ?>"><i class='bx bxl-youtube'></i>
                        <span><?php echo  esc_html(__($instance['youtube_txt'], 'drivco-core')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
        </ul>
    ...
    ?>
        <p>
            <label for="<?php echo $this->get_field_id('facebook_txt'); ?>"><?php _e('Facebook Text:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('facebook_url'); ?>"><?php _e('Facebook URL:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('instagram_txt'); ?>"><?php _e('Instagram Text:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('instagram_url'); ?>"><?php _e('Instagram URL:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('twitter_txt'); ?>"><?php _e('Twitter Text:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('twitter_url'); ?>"><?php _e('Twitter URL:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('linkedin_txt'); ?>"><?php _e('Linkedin Text:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('linkedin_url'); ?>"><?php _e('Linkedin URL:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('dribbble_txt'); ?>"><?php _e('Dribbble Text:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('dribbble_url'); ?>"><?php _e('Dribbble URL:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('pinterest_txt'); ?>"><?php _e('Pinterest Text:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('pinterest_url'); ?>"><?php _e('Pinterest URL:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('whatsapp_txt'); ?>"><?php _e('Whatsapp Text:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('whatsapp_url'); ?>"><?php _e('Whatsapp URL:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('youtube_txt'); ?>"><?php _e('Youtube Text:', 'drivco-core'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('youtube_url'); ?>"><?php _e('Youtube URL:', 'drivco-core'); ?></label>
