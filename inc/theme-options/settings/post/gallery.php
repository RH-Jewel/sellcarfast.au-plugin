...
CSF::createSection(
	$gallery_prefix,
	array(
		'title'  => esc_html__('Gallery Post Setting', 'drivco-core'),
		'fields' => array(
			array(
				'id'          => 'egns_gallery_images',
				'type'        => 'gallery',
				'title'       => esc_html__('Add Gallery Images', 'drivco-core'),
				'desc'        => esc_html__('Please Upload Or Select Images From Media Library.', 'drivco-core'),
				'add_title'   => esc_html__('Add Images', 'drivco-core'),
				'edit_title'  => esc_html__('Edit Gallery', 'drivco-core'),
