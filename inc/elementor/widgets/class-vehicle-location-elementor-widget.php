...
class Drivco_Vehicle_Location_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'drivco_vehicle_location';
    }

    public function get_title()
    {
        return esc_html__('EG Vehicle Location', 'drivco-core');
    }
    ...
    protected function register_controls()
    {
        ...
        //=====================Vehicle Location Product Widget =======================//

        //grneral section
        $this->start_controls_section(
            'drivco_vehicle_location_general_section',
            [
        ...
        $this->add_control(
            'drivco_vehicle_location_brand',
            [
                'label' => __('Product Location', 'drivco-core'),
        ...
        $this->add_control(
            'drivco_vehicle_location_order_by',
            [
        ...
        $this->add_control(
            'drivco_vehicle_location_posts_per_page',
            [
        ...
        $this->start_controls_section(
            'drivco_vehicle_location_heading_section',
            [
        ...
        $this->add_control(
            'drivco_vehicle_location_subtitle',
            [
        ...
        $this->start_controls_section(
            'drivco_vehicle_location_viewall_section',
            [
        ...
        $this->start_controls_section(
            'drivco_vehicle_location_view_btn_area',
            [
        ...
        $this->add_control(
            'drivco_vehicle_location_view_btn_text',
            [
                'label' => esc_html__('Button Text', 'drivco-core'),
        ...
        $this->add_control(
            'drivco_vehicle_view_details_btn_link',
            [
                'label' => esc_html__('Button Link', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::URL,
                'options' => ['url', 'is_external', 'nofollow'],
        ...
        //Sub Title
        $this->start_controls_section(
            'drivco_vehicle_location_subtitle_sec',
            [
                'label' => esc_html__('Sub Title', 'drivco-core'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'drivco_vehicle_location_subtitle_typ',
        ...
        $this->add_control(
            'drivco_vehicle_location_subtitle_color',
            [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_subtitle_margin',
            [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_subtitle_padding',
            [
        ...
        // Title
        $this->start_controls_section(
            'drivco_vehicle_location_title_sec',
            [
                'label' => esc_html__('Title', 'drivco-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_location_title_typ',
        ...
        $this->add_control(
            'drivco_vehicle_location_title_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_title_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_title_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        //Tab
        $this->start_controls_section(
            'drivco_vehicle_location_cat_tab',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_location_cat_tab_typ',
                'selector' => '{{WRAPPER}} .top-rate-used-car-area .form-inner select.option',
            ]
        );

        $this->add_control(
            'drivco_vehicle_location_cat_tab_color',
            [
                'label'     => esc_html__('Active Tab Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .top-rate-used-car-area .form-inner .nice-select select.option.active' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        //Car Model
        $this->start_controls_section(
            'drivco_vehicle_location_car_model_sec',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_location_car_model_typ',
        ...
        $this->add_control(
            'drivco_vehicle_location_car_model_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'drivco_vehicle_location_car_model_hover_color',
            [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_car_model_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_car_model_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        //Price
        $this->start_controls_section(
            'drivco_vehicle_location_price_sec',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_location_price_typ',
        ...
        $this->add_control(
            'drivco_vehicle_location_price_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_price_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_price_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_location_typ',
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        //Features 
        $this->start_controls_section(
            'drivco_vehicle_location_features_sec',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_location_features_typ',
        ...
        $this->add_control(
            'drivco_vehicle_location_features_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_features_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_features_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        //Button Text
        $this->start_controls_section(
            'drivco_vehicle_location_button_text_sec',
            [
                'label' => esc_html__('Button Text', 'drivco-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_location_button_text_typ',
        ...
        $this->add_control(
            'drivco_vehicle_location_button_text_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'drivco_vehicle_location_button_text_color_hover_color',
            [
                'label'     => esc_html__('Hover  Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_button_text_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_location_button_text_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
    ...
    protected function render()
    {
        ...
        $selected_location_ids = $settings['drivco_vehicle_location_brand'];

        $terms = get_terms(array('taxonomy' => 'location', 'slug' => $selected_location_ids));



        $args = array(
            'post_type'      => 'vehicle',
            'posts_per_page' => !empty($settings['drivco_vehicle_location_posts_per_page']) ? $settings['drivco_vehicle_location_posts_per_page'] : 4,
            'orderby'        => $settings['drivco_vehicle_location_order_by'],
            'order'          => $settings['drivco_vehicle_location_order'],
            'offset'         => 0,
            'post_status'    => 'publish',
        );
...
?>
        ...
        <div class="top-rate-used-car-area">
            <div class="container">
                <div class="row mb-60">
                    <div class="col-lg-12 d-flex align-items-end justify-content-between flex-wrap gap-4">
                        <div class="section-title1">
                            <?php if (!empty($settings['drivco_vehicle_location_subtitle'])) : ?>
                                <span><?php echo $settings['drivco_vehicle_location_subtitle'] ?></span>
                            <?php endif; ?>
                            <?php if (!empty($settings['drivco_vehicle_location_title'])) : ?>
                                <h2><?php echo $settings['drivco_vehicle_location_title'] ?></h2>
                            <?php endif; ?>
                        </div>
                        <div class="form-inner">
                            <label><?php echo ('Filter By :') ?> </label>
                            <select class="location_filter">
                                <option value="" selected><?php echo esc_html__('Select Location', 'drivco-core') ?></option>
            ...
            <div class="container-fluid">
                <div class="row g-4 mb-40" id="vehicle_location_data">
                    <?php
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="content-btm">
                                        <a class="view-btn2" href="<?php the_permalink() ?>">
                                            ...
                                            <?php echo esc_html($settings['drivco_vehicle_view_btn_text']) ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php if (!empty($settings['drivco_vehicle_location_view_btn_text'])) :   ?>
                            <div class="view-btn-area">
                                <p><?php echo esc_html('Availabe Thousand of Car in') ?></p>
                                <a class="view-btn" href="<?php echo esc_url($settings['drivco_vehicle_view_details_btn_link']['url']) ?>"> <?php echo esc_html($settings['drivco_vehicle_location_view_btn_text']) ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
Plugin::instance()->widgets_manager->register(new Drivco_Vehicle_Location_Widget());
