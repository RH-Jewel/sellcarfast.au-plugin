...
class Drivco_Vehicle_Product_Cat_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'drivco_vehicle_product_cat';
    }

    public function get_title()
    {
        return esc_html__('EG Vehicle Category Tab', 'drivco-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'drivco_vehicle_product_tab_cat_sec',
            [
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_style_selection',
            [
        ...
        //Heading style One
        $this->start_controls_section(
            'drivco_vehicle_product_cat_heading',
            [
                'label' => esc_html__('Headings', 'drivco-core'),
                'condition' => [
                    'drivco_vehicle_product_cat_style_selection' => 'style_one'
                ]
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_cat_heading_title',
            [
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_heading_subtitle',
            [
                'label' => esc_html__('Heading Subtitle', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Recent Launched', 'drivco-core'),
                'label_block' => true,
            ]
        );
        ...
        //Heading style Two
        $this->start_controls_section(
            'drivco_vehicle_product_two_cat_heading',
            [
                'label' => esc_html__('Headings', 'drivco-core'),
                'condition' => [
                    'drivco_vehicle_product_cat_style_selection' => 'style_two'
                ]
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_two_cat_heading_title',
            [
                'label' => esc_html__('Heading Title', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
        ...
        $this->add_control(
            'drivco_vehicle_product_two_cat_heading_subtitle',
            [
                'label' => esc_html__('Heading Subtitle', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
        ...
        //grneral section
        $this->start_controls_section(
            'drivco_vehicle_product_cat_general_section',
            [
                'label' => esc_html__('Category Section', 'drivco-core')
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_cat',
            [
                'label' => __('Product Category', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::SELECT2,
                'label_block' => true,
                'multiple' => true,
                'options' =>  Egns_Core\Egns_Helper::get_all_cat(),
                'default' =>  Egns_Core\Egns_Helper::get_all_cat(),
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_cat_order',
            [
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_order_by',
            [
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_posts_per_page',
            [
        ...
        $this->start_controls_section(
            'drivco_vehicle_product_cat_tab',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'drivco_vehicle_product_cat_tab_typ',
                'selector' => '{{WRAPPER}} .recent-product-section .nav-tabs li button',
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_cat_tab_color',
            [
                'label'     => esc_html__('Active Tab Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .recent-product-section .nav-tabs li button.active' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_cat_tab_active_bg_color',
            [
                'label'     => esc_html__(' Active Tab Bac Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .recent-product-section .nav-tabs li button.active' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        //Car Model
        $this->start_controls_section(
            'drivco_vehicle_product_cat_car_model_sec',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_cat_car_model_typ',
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_car_model_color',
            [
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_car_model_hover_color',
            [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_car_model_margin',
            [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_car_model_padding',
            [
        ...
        //Price
        $this->start_controls_section(
            'drivco_vehicle_product_cat_price_sec',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_cat_price_typ',
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_price_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_price_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_price_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        //Location
        $this->start_controls_section(
            'drivco_vehicle_product_cat_sec',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_cat_typ',
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        //Features 
        $this->start_controls_section(
            'drivco_vehicle_product_cat_features_sec',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_cat_features_typ',
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_features_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_features_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_features_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        //Button Text
        $this->start_controls_section(
            'drivco_vehicle_product_cat_button_text_sec',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_cat_button_text_typ',
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_button_text_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_button_text_color_hover_color',
            [
                'label'     => esc_html__('Hover  Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_button_text_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_button_text_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
        ...
        //Tab
        $this->start_controls_section(
            'drivco_vehicle_product_two_cat_tab',
            [
                'label' => esc_html__('Product Tab Menu', 'drivco-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_two_cat_tab_typ',
                'selector' => '{{WRAPPER}} .home3-featured-car-area .tab-and-btn ul li button',
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_two_cat_tab_color',
            [
                'label'     => esc_html__('Active Tab Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .home3-featured-car-area .tab-and-btn ul li button.active' => 'color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_two_cat_tab_active_bg_color',
            [
                'label'     => esc_html__(' Active Tab Bac Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .home3-featured-car-area .tab-and-btn ul li button.active' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        //Price
        $this->start_controls_section(
            'drivco_vehicle_product_cat_two_price_sec',
            [
                'label' => esc_html__('Price', 'drivco-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_cat_two_price_typ',
                'selector' => '{{WRAPPER}} .product-card3 .product-content .price-location .price strong',

            ]
        );

        $this->add_control(
            'drivco_vehicle_product_cat_two_price_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .product-card3 .product-content .price-location .price strong' => '-webkit-text-fill-color: {{VALUE}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'drivco_vehicle_product_cat_two_price_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .product-card3 .product-content .price-location .price strong' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'drivco_vehicle_product_cat_two_price_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .product-card3 .product-content .price-location .price strong' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
        ...
        //Location
        $this->start_controls_section(
            'drivco_vehicle_product_cat_two_sec',
            [
                'label' => esc_html__('Location', 'drivco-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_cat_two_typ',
                'selector' => '{{WRAPPER}} .product-card3 .product-content .price-location .location a',

            ]
        );

        $this->add_control(
            'drivco_vehicle_product_cat_two_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .product-card3 .product-content .price-location .location a' => '-webkit-text-fill-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_two_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .product-card3 .product-content .price-location .location a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'drivco_vehicle_product_cat_two_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .product-card3 .product-content .price-location .location a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
        ...
        //Car Model
        $this->start_controls_section(
            'drivco_vehicle_product_cat_two_car_model_sec',
            [
                'label' => esc_html__('Product Model', 'drivco-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'drivco-core'),
                'name'     => 'drivco_vehicle_product_cat_two_car_model_typ',
        ...
        $this->add_control(
            'drivco_vehicle_product_cat_two_car_model_color',
            [
                'label'     => esc_html__('Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .product-card3 .product-content h5 a' => '-webkit-text-fill-color: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'drivco_vehicle_product_cat_two_car_model_hover_color',
            [
                'label'     => esc_html__('Hover  Color', 'drivco-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_two_car_model_margin',
            [
                'label' => esc_html__('Margin', 'drivco-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control(
            'drivco_vehicle_product_cat_two_car_model_padding',
            [
                'label'      => __('Padding', 'drivco-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
    ...
    protected function render()
    {
        ...
        $selected_cat_ids = $settings['drivco_vehicle_product_cat'];

        $terms = get_terms(array('taxonomy' => 'vehicle-category', 'slug' => $selected_cat_ids, 'orderby' => 'id', 'order'    => 'DESC'));



        $args = array(
            'post_type'      => 'vehicle',
            'posts_per_page' => $settings['drivco_vehicle_product_cat_posts_per_page'],
            'orderby'        => $settings['drivco_vehicle_product_cat_order_by'],
            'order'          => $settings['drivco_vehicle_product_cat_order'],
            'offset'         => 0,
            'post_status'    => 'publish',
        );

        // Add the brand filter if any cat are selected
...
?>
        ...
        <?php if ($settings["drivco_vehicle_product_cat_style_selection"] == "style_one") : ?>
            <div class="recent-product-section">
                <div class="row mb-60">
                    <div class="col-lg-12 d-flex align-items-end justify-content-between flex-wrap gap-4">
                        <div class="section-title1">
                            <?php if (!empty($settings['drivco_vehicle_product_cat_heading_subtitle'])) : ?>
                                <span><?php echo esc_html($settings['drivco_vehicle_product_cat_heading_subtitle']) ?></span>
                            <?php endif; ?>
                            <?php if (!empty($settings['drivco_vehicle_product_cat_heading_title'])) : ?>
                                <h2><?php echo esc_html($settings['drivco_vehicle_product_cat_heading_title']) ?></h2>
                            <?php endif; ?>
                        </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab6" role="tablist">
                            ...
                            ?>
                                <li class="nav-item" role="presentation">
                                    <button class="<?php echo $tab_class ?>" id="car-tab<?php echo $term_id ?>" data-bs-toggle="tab" data-bs-target="#car<?php echo $term_id ?>" type="button" role="tab" aria-controls="car<?php echo $term_id ?>" aria-selected="true"><?php echo $term_name ?? '' ?></button>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    ...
                    <div class="col-lg-12">
                        <div class="tab-content" id="myTabContent6">
                            ...
                            ?>
                                ...
                                <div class="<?php echo $tab_class ?>" id="car<?php echo $term_id ?>" role="tabpanel" aria-labelledby="car-tab<?php echo $term_id ?>">
                                                    ...
                                                    <div class="product-img">
                                                        ...
                                                        if (!empty(Egns_Core\Egns_Helper::egns_vehicle_product_value('vehicle_exterior_gallery'))) : ?>
                                                            ...
                                                            <div class="number-of-img">
                                                                <a href="#<?php echo $id ?>" class="btn-gallery"><img src="<?php echo get_template_directory_uri() . '/assets/img/home1/icon/gallery-icon-1.svg' ?>" alt="<?php echo esc_attr('gallery-icon', 'drivco-core') ?>"><?php echo $i ?></a>
                                                            </div>
                                                        <?php endif; ?>
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <div class="content-btm">
                                                            <a class="view-btn2" href="<?php the_permalink() ?>">
                                                                ...
                                                                <?php echo esc_html__('View Details', 'drivco-core') ?>
                                                            </a>
        ...
        <?php if ($settings["drivco_vehicle_product_cat_style_selection"] == "style_two") : ?>
            <div class="home3-featured-car-area">
                <div class="container">
                    <div class="row mb-50">
                        <div class="col-lg-12 d-flex align-items-end justify-content-between gap-3 flex-lg-nowrap flex-wrap">
                            <div class="section-title-2">
                                <?php if (!empty($settings['drivco_vehicle_product_two_cat_heading_title'])) : ?>
                                    <h2><?php echo esc_html($settings['drivco_vehicle_product_two_cat_heading_title']) ?></h2>
                                <?php endif; ?>
                                <?php if (!empty($settings['drivco_vehicle_product_two_cat_heading_subtitle'])) : ?>
                                    <p><?php echo esc_html($settings['drivco_vehicle_product_two_cat_heading_subtitle']) ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="tab-and-btn">
...
Plugin::instance()->widgets_manager->register(new Drivco_Vehicle_Product_Cat_Widget());
