...
function get_location_vehicle_data()
{

    $location_id = !empty($_GET['location']) ? sanitize_text_field($_GET['location']) : '';
                ...
                <div class="product-img">
                    ...
                    if (!empty(Egns_Core\Egns_Helper::egns_vehicle_product_value('vehicle_exterior_gallery'))) : ?>
                        ...
                        <div class="number-of-img">
                            <a href="#<?php echo $id ?>" class="btn-gallery"><img src="<?php echo get_template_directory_uri() . '/assets/img/home1/icon/gallery-icon-1.svg' ?>" alt="<?php echo esc_attr__('num-image', 'drivco-core') ?>"><?php echo $i ?></a>
                        </div>
                    <?php endif; ?>
...
add_action("wp_ajax__get_location_vehicle_data", "get_location_vehicle_data");
add_action("wp_ajax_nopriv__get_location_vehicle_data", "get_location_vehicle_data");
